...
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    ...
    firstDefinedIn: 'plans/02-classic',
    alsoAppears: ['practice/13-next-course', 'practice/14-futures-to-options'],
  ...
  },
  {
    ...
    alsoAppears: ['plans/05-orderflow', 'practice/08-heuristics-as-reading', 'practice/12-misreads'],
    kind: 'hygiene',
  },
  {
    id: 'folklore',
  ...
  },
  {
    ...
    firstDefinedIn: 'plans/02-classic',
    alsoAppears: ['practice/12-misreads'],
    kind: 'hygiene',
  },
  {
  ...
  },
  {
    ...
    firstDefinedIn: 'plans/01-what-gexbot-is',
    alsoAppears: ['plans/02-classic', 'practice/13-next-course'],
    distinguishingCut:
  ...
  },
  {
    ...
    firstDefinedIn: 'practice/10-early-session',
    alsoAppears: ['practice/11-structure-and-leftover'],
    distinguishingCut:
  ...
  },
  {
    ...
    firstDefinedIn: 'practice/13-next-course',
    distinguishingCut:
  ...
  },
  {
    ...
    firstDefinedIn: 'practice/14-futures-to-options',
    distinguishingCut:
  ...
  },
  {
    ...
    firstDefinedIn: 'plans/03-classification',
    alsoAppears: ['practice/09-grammar-and-journal', 'practice/11-structure-and-leftover'],
    kind: 'hygiene',
  },
  {
    id: 'node',
  ...
  },
  {
    ...
    firstDefinedIn: 'plans/04-state',
    alsoAppears: ['practice/08-heuristics-as-reading', 'practice/11-structure-and-leftover'],
  ...
  },
  {
    ...
    firstDefinedIn: 'practice/09-grammar-and-journal',
    alsoAppears: ['practice/11-structure-and-leftover', 'practice/12-misreads'],
  ...
  },
  {
    ...
    firstDefinedIn: 'practice/12-misreads',
  ...
  },
  {
    ...
    firstDefinedIn: 'practice/11-structure-and-leftover',
  ...
  },
  {
    ...
    shortDef:
      'The journal-line field added in Chapter 11: a tape sentence for what price did at the node. Not a Gexbot screen name.',
    firstDefinedIn: 'practice/11-structure-and-leftover',
    alsoAppears: ['practice/12-misreads'],
  ...
  },
  {
    ...
    shortDef:
      'The high and low of the first minutes of cash hours. Fifteen minutes is the finest box this book uses (Chapter 10); it completes when leftover is barely nameable. Thirty to sixty minutes is the safer box (Chapter 11). A tape box, not a Gexbot node. A break is price leaving that box and staying out.',
    firstDefinedIn: 'practice/10-early-session',
    alsoAppears: ['practice/11-structure-and-leftover'],
  ...
  },
  {
    ...
    shortDef:
      'Price prints beyond a level and immediately returns inside. In Chapter 10 the level is a compound zone reached by an open drive (E4); in Chapter 11 it is a swing high or low (S6). Tape structure. Not a Gexbot object until paired with a node and a pressure word.',
    firstDefinedIn: 'practice/10-early-session',
    alsoAppears: ['practice/11-structure-and-leftover'],
  ...
  },
  {
    ...
    firstDefinedIn: 'practice/10-early-session',
    alsoAppears: ['practice/13-next-course'],
  ...
  },
  {
    ...
    shortDef:
      'Chapter 10’s division of the early window by what Gexbot can say. Phase 0 (pre-open): levels; Classic OI only; pressure unknown. Phase 1 (09:30–09:45): fifteen-minute range forming; Classic volume and max-change; State too thin. Phase 2 (09:45–10:30): leftover nameable; H12, H13, grades. Phase 3 (10:30–11:00): sequence for H3; early window closes. Boundaries approximate; knowability decides each day.',
    firstDefinedIn: 'practice/10-early-session',
  ...
  },
  {
    ...
    shortDef:
      'The day is starting narrow: overnight range inside yesterday’s, fifteen-minute range inside both. A lean, not a day-type. Chapter 11’s range day is the full-day form once the tape has shown it.',
    firstDefinedIn: 'practice/10-early-session',
  ...
  },
  {
    ...
    shortDef:
      'The day is starting displaced: overnight range beyond a yesterday extreme, or a gap. A lean, not a day-type. Chapter 11’s trend day is the full-day form once the tape has shown it. If the overnight move carried spot past a Classic open-interest major, that node is now behind price, re-marked, owner unknown.',
    firstDefinedIn: 'practice/10-early-session',
  ...
  },
  {
    ...
    alsoAppears: ['practice/14-futures-to-options'],
  ...
  },
  {
    ...
    alsoAppears: ['on-ramp/09-grammar-and-journal', 'practice/14-futures-to-options'],
  ...
  },
  {
    ...
    firstDefinedIn: 'on-ramp/10-early-session',
  ...
  },
  {
    ...
    firstDefinedIn: 'on-ramp/11-structure-and-leftover',
  ...
  },
  {
    ...
    shortDef:
      'The holder-seat form of a Chapter 12 reading misread. The same error that costs a reader a thesis costs a holder premium: “DEX bar = pending buying” becomes “buying calls makes the market go up.”',
    firstDefinedIn: 'on-ramp/12-misreads',
  ...
  },
  {
    ...
    shortDef:
      'A position written down at the open but not held, tracked at market marks and attributed at the close with Chapter 13’s ledger. The on-ramp’s way of running a holder’s arithmetic with no money at risk.',
    firstDefinedIn: 'on-ramp/13-next-course',
    alsoAppears: ['practice/14-futures-to-options'],
  ...
  },
  {
    ...
    headword: 'hand price',
    shortDef:
      'The price of the at-the-money option worked out in the head from index level, time to expiry, and implied vol, before looking at the chain. Chapter 14’s Stage 1 gate is a hand price inside the bid–ask most days.',
    firstDefinedIn: 'on-ramp/14-futures-to-options',
  ...
  },
  {
    ...
    bearsOn:
      'The seat you can sit in is decided before the first ticket. The tier also enforces, from outside, the order Chapter 14’s ramp asks you to keep from inside: defined risk before undefined.',
    evidence: 'market-general',
  ...
  },
  {
    ...
    bearsOn:
      'They are the practitioner’s answer to “was the vol I paid high or low,” which the vol regime alone does not say; a falling-vol day can still be a high-vol-paid day. Chapter 14’s morning card asks for this line without naming the tool.',
    evidence: 'market-general',
  ...
  },
  {
    ...
    bearsOn:
      'The falsifier field is a pre-registration for one trade, and Chapter 13’s rule to write the hypothesis before the plot is the same idea for a study. Without it, the journal turns into a record of things that happened, all of which look explicable afterwards.',
    evidence: 'market-general',
  ...
  },
  {
    ...
    bearsOn:
      'It is the trader’s word for the two rows of the 2×2 taken together. Chapter 14 uses it without ceremony; from the customer seat it is the first question about any position, before strike or direction.',
    evidence: 'market-general',
  ...
  },
  {
    ...
    bearsOn:
      'It is the NDX analogue of the small-size route Chapter 14 describes, at about one-fortieth of an NQ future in delta at the money. The screen reads NDX; the ticket, at that size, would be XND.',
    evidence: 'market-general',
  ...
  },
  {
    ...
    bearsOn:
      'A futures trader knows their contract’s notional; a writer of ETF options inherits a share position they did not size. It is the concrete form of the writer’s obligation that Chapter 14’s instrument table asks you to state before choosing.',
    evidence: 'market-general',
  ...
  },
  {
    ...
    bearsOn:
      'A paper position can be rebuilt and re-marked across weeks from these, which is how Chapter 13’s forty sessions become a dataset. The intraday marks the on-ramp uses are not in them; the closing marks are.',
    evidence: 'market-general',
  ...
  },
  {
    ...
    bearsOn:
      'It is the plain, non-selling introduction to the mechanics that Chapter 14’s Gap 5 requires, and it is free. It teaches the customer seat; it does not teach the reading this book does.',
    evidence: 'market-general',
...
/** Chapter number from a doc id (`practice/10-…` → 10), then the id as tiebreak. */
